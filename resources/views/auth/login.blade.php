    ...
    <div class="container d-flex justify-content-center align-items-center min-vh-100">
        ...
        <div class="row border rounded-5 p-3 bg-white shadow box-area w-100" style="max-width: 900px;">
            ...
            <div class="featured-image mb-3">
                ...
                <div class="featured-image mb-3">
                    <img src="{{ asset('img/login.png') }}" class="img-fluid" style="width: 250px;" alt="Login Illustration">
                </div>
                ...
                <small class="text-white text-wrap text-center" style="width: 17rem; font-family: 'Poppins', sans-serif; line-height: 1.5;">
                    Start your journey
                </small>
            </div>
